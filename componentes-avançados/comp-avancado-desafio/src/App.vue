<template>
	<div id="app">
		<span>
			<button @click="$event => componente = 'Vermelho'" class="vermelho">Carregar Componente Vermelho</button>
			<button @click="$event => componente = 'Verde'"  class="verde">Carregar Componente Verde</button>
			<button @click="$event => componente = 'Azul'"  class="azul">Carregar Componente Azul</button>
		</span>
