<template>
	<div id="app">
		...
		<!-- Toma cuidado com a diretiva v-html
		para não sofrer ataques cross-site scripting (XSS) -->
		<p v-html="'Usando diretiva <strong>v-html</strong>'"></p>
		<hr>
		<!-- Abaixo um exemplo de cor já definida na diretiva -->
		<!-- <p v-destaque>Usando diretiva personalizada.</p> -->

		<!-- Abaixo um exemplo de definição de cor -->
